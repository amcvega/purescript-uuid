...
(function(exports) {
  ...
  var uuidToString = function (v) {
      return (function ($7) {
          return Data_String.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(toHex)($7));
      })(Data_Array.take(8)(v.value0)) + ("-" + ((function ($8) {
          return Data_String.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(toHex)(Data_Array.take(4)($8)));
      })(Data_Array.drop(8)(v.value0)) + ("-" + ((function ($9) {
          return Data_String.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(toHex)(Data_Array.take(4)($9)));
      })(Data_Array.drop(12)(v.value0)) + ("-" + ((function ($10) {
          return Data_String.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(toHex)(Data_Array.take(4)($10)));
      })(Data_Array.drop(16)(v.value0)) + ("-" + (function ($11) {
          return Data_String.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(toHex)(Data_Array.take(12)($11)));
  ...
  var uuidV4 = function (i32s) {
      return new Uuid(int128ToHexes(i32s));
  };
  exports["Uuid"] = Uuid;
